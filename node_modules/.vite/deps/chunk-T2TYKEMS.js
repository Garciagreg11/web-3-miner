...
var svg2 = tag(SVG_RESULT);
var mathml2 = tag(MATHML_RESULT);
...
var getTemplateHtml = (strings, type) => {
  ...
  const attrNames = [];
  let html4 = type === SVG_RESULT ? "<svg>" : type === MATHML_RESULT ? "<math>" : "";
  let rawTextEndRegex;
  ...
  for (let i = 0; i < l; i++) {
    ...
    html4 += regex === textEndRegex ? s + nodeMarker : attrNameEndIndex >= 0 ? (attrNames.push(attrName), s.slice(0, attrNameEndIndex) + boundAttributeSuffix + s.slice(attrNameEndIndex)) + marker + end : s + marker + (attrNameEndIndex === -2 ? i : end);
  }
  const htmlResult = html4 + (strings[l] || "<?>") + (type === SVG_RESULT ? "</svg>" : type === MATHML_RESULT ? "</math>" : "");
...
var Template = class _Template {
  constructor({ strings, ["_$litType$"]: type }, options) {
    ...
    const [html4, attrNames] = getTemplateHtml(strings, type);
    this.el = _Template.createElement(html4, options);
...
\`` + strings.join("${...}") + "`");
  ...
  /** @nocollapse */
  static createElement(html4, _options) {
...
var ReactiveElement = class extends HTMLElement {
  ...
  __propertyToAttribute(name, value) {
    ...
    if (attr !== void 0 && options.reflect === true) {
      const converter = ((_a3 = options.converter) == null ? void 0 : _a3.toAttribute) !== void 0 ? options.converter : defaultConverter2;
  ...
  _$attributeToProperty(name, value) {
    ...
    if (propName !== void 0 && this.__reflectingProperty !== propName) {
      ...
      const converter = typeof options.converter === "function" ? { fromAttribute: options.converter } : ((_a3 = options.converter) == null ? void 0 : _a3.fromAttribute) !== void 0 ? options.converter : defaultConverter2;
...
var _a2;
(_a2 = global4.litElementHydrateSupport) == null ? void 0 : _a2.call(global4, { LitElement: LitElement2 });
...
var ifDefined = (value) => value ?? nothing2;
...
// node_modules/@reown/appkit-ui/node_modules/lit-html/development/static.js
...
var html3 = withStatic(html);
var svg3 = withStatic(svg);
var mathml3 = withStatic(mathml);
...
var phosphorImports = {
  "ph-arrow-circle-down": () => import("./PhArrowCircleDown-VLTTMYLS.js"),
  "ph-arrow-clockwise": () => import("./PhArrowClockwise-AEVQP7PD.js"),
  "ph-arrow-down": () => import("./PhArrowDown-SDIFAQ2X.js"),
  "ph-arrow-left": () => import("./PhArrowLeft-JHAZLR65.js"),
  "ph-arrow-right": () => import("./PhArrowRight-72CYJMO6.js"),
  "ph-arrow-square-out": () => import("./PhArrowSquareOut-QBKYK4MK.js"),
  "ph-arrows-down-up": () => import("./PhArrowsDownUp-V6XSY7AO.js"),
  "ph-arrows-left-right": () => import("./PhArrowsLeftRight-2JIQB6TE.js"),
  "ph-arrow-up": () => import("./PhArrowUp-YGKEJUI7.js"),
  "ph-arrow-up-right": () => import("./PhArrowUpRight-JEVOVANJ.js"),
  "ph-arrows-clockwise": () => import("./PhArrowsClockwise-64WNE5QB.js"),
  "ph-bank": () => import("./PhBank-C7EMKGG6.js"),
  "ph-browser": () => import("./PhBrowser-7FUV4BTO.js"),
  "ph-caret-down": () => import("./PhCaretDown-7JVNBBTG.js"),
  "ph-caret-left": () => import("./PhCaretLeft-6OBJRO2U.js"),
  "ph-caret-right": () => import("./PhCaretRight-35Z6CODO.js"),
  "ph-caret-up": () => import("./PhCaretUp-RBIRPSN4.js"),
  "ph-check": () => import("./PhCheck-VQ5437NK.js"),
  "ph-circle-half": () => import("./PhCircleHalf-LRD566Y7.js"),
  "ph-clock": () => import("./PhClock-CHWFVWNO.js"),
  "ph-compass": () => import("./PhCompass-7DVCHINI.js"),
  "ph-copy": () => import("./PhCopy-UVENVELV.js"),
  "ph-credit-card": () => import("./PhCreditCard-D373VN5Z.js"),
  "ph-currency-dollar": () => import("./PhCurrencyDollar-JICYXCRV.js"),
  "ph-desktop": () => import("./PhDesktop-NJSEMLAD.js"),
  "ph-device-mobile": () => import("./PhDeviceMobile-MIYSD7DZ.js"),
  "ph-dots-three": () => import("./PhDotsThree-EPEC5BTJ.js"),
  "ph-vault": () => import("./PhVault-IUG6RJQ7.js"),
  "ph-envelope": () => import("./PhEnvelope-57LY7SDV.js"),
  "ph-funnel-simple": () => import("./PhFunnelSimple-WK7APLAE.js"),
  "ph-globe": () => import("./PhGlobe-MKDHF343.js"),
  "ph-identification-card": () => import("./PhIdentificationCard-EUCGNDY5.js"),
  "ph-image": () => import("./PhImage-HW722TME.js"),
  "ph-info": () => import("./PhInfo-SP3V5BOE.js"),
  "ph-lightbulb": () => import("./PhLightbulb-J4UOWC3R.js"),
  "ph-magnifying-glass": () => import("./PhMagnifyingGlass-BZKUPJJN.js"),
  "ph-paper-plane-right": () => import("./PhPaperPlaneRight-EGM2F5P3.js"),
  "ph-plus": () => import("./PhPlus-J2J46QMY.js"),
  "ph-power": () => import("./PhPower-GUBHY2KT.js"),
  "ph-puzzle-piece": () => import("./PhPuzzlePiece-C5MPWLTX.js"),
  "ph-qr-code": () => import("./PhQrCode-5RP5AWZ7.js"),
  "ph-question": () => import("./PhQuestion-B7FGEJGK.js"),
  "ph-question-circle": () => import("./PhQuestionMark-JK7ICVFR.js"),
  "ph-seal-check": () => import("./PhSealCheck-XL6PKNC2.js"),
  "ph-sign-out": () => import("./PhSignOut-DDVQQUTY.js"),
  "ph-spinner": () => import("./PhSpinner-SWVV5H6M.js"),
  "ph-trash": () => import("./PhTrash-JHU2JTR5.js"),
  "ph-user": () => import("./PhUser-FSPOCEIO.js"),
  "ph-wallet": () => import("./PhWallet-TWMYZV4T.js"),
  "ph-warning": () => import("./PhWarning-BVAEY7QS.js"),
  "ph-warning-circle": () => import("./PhWarningCircle-ATPTRY5Y.js"),
  "ph-x": () => import("./PhX-6A7ZFLET.js")
};
var svgOptions = {
...
var WuiIcon = class WuiIcon2 extends LitElement {
  ...
  render() {
    ...
    if (phosphorIconTag && phosphorIconTag !== "") {
      ...
      const tag2 = unsafeStatic(phosphorIconTag);
      ...
      return html3`<${tag2} size=${getPhosphorSize[this.size]} weight="${this.weight}"></${tag2}>`;
    }
    return svgOptions[this.name] || html3``;
  }
};
...
var WuiIconBox = class WuiIconBox2 extends LitElement {
  ...
  render() {
    ...
    return html`
      <wui-icon size=${ifDefined2(this.size)} name=${this.icon} color="inherit"></wui-icon>
    `;
  }
};
...
var WuiImage = class WuiImage2 extends LitElement {
  ...
  render() {
    ...
    return html`<img src=${ifDefined2(this.src)} alt=${this.alt} @error=${this.handleImageError} />`;
  }
  handleImageError() {
...
var __decorate8 = function(decorators, target, key, desc3) {
  var c = arguments.length, r = c < 3 ? target : desc3 === null ? desc3 = Object.getOwnPropertyDescriptor(target, key) : desc3, d2;
  if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc3);
  else for (var i = decorators.length - 1; i >= 0; i--) if (d2 = decorators[i]) r = (c < 3 ? d2(r) : c > 3 ? d2(target, key, r) : d2(target, key)) || r;
  return c > 3 && r && Object.defineProperty(target, key, r), r;
...
var __decorate9 = function(decorators, target, key, desc3) {
  var c = arguments.length, r = c < 3 ? target : desc3 === null ? desc3 = Object.getOwnPropertyDescriptor(target, key) : desc3, d2;
  if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc3);
  else for (var i = decorators.length - 1; i >= 0; i--) if (d2 = decorators[i]) r = (c < 3 ? d2(r) : c > 3 ? d2(target, key, r) : d2(target, key)) || r;
  return c > 3 && r && Object.defineProperty(target, key, r), r;
...
var WuiListWallet = class WuiListWallet2 extends LitElement {
  ...
  templateNamespaces() {
    var _a3;
    if ((_a3 = this.namespaces) == null ? void 0 : _a3.length) {
      return html`<wui-flex alignItems="center" gap="0">
        ...
        return html`<wui-flex
              ...
              zIndex=${(((_a4 = this.namespaces) == null ? void 0 : _a4.length) ?? 0) * 2 - index}
              class="namespace-icon"
            >
              <wui-icon
                name=${ifDefined2(NAMESPACE_ICONS[namespace])}
                size="sm"
                color="default"
              ></wui-icon>
            </wui-flex>`;
  ...
  templateWalletImage() {
    if (!this.showAllWallets && this.imageSrc) {
      return html`<wui-wallet-image
        size=${ifDefined2(this.size === "sm" ? "sm" : "md")}
...
var __decorate10 = function(decorators, target, key, desc3) {
  var c = arguments.length, r = c < 3 ? target : desc3 === null ? desc3 = Object.getOwnPropertyDescriptor(target, key) : desc3, d2;
  if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc3);
  else for (var i = decorators.length - 1; i >= 0; i--) if (d2 = decorators[i]) r = (c < 3 ? d2(r) : c > 3 ? d2(target, key, r) : d2(target, key)) || r;
  return c > 3 && r && Object.defineProperty(target, key, r), r;
...
var __decorate11 = function(decorators, target, key, desc3) {
  var c = arguments.length, r = c < 3 ? target : desc3 === null ? desc3 = Object.getOwnPropertyDescriptor(target, key) : desc3, d2;
  if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc3);
  else for (var i = decorators.length - 1; i >= 0; i--) if (d2 = decorators[i]) r = (c < 3 ? d2(r) : c > 3 ? d2(target, key, r) : d2(target, key)) || r;
  return c > 3 && r && Object.defineProperty(target, key, r), r;
...
var __decorate12 = function(decorators, target, key, desc3) {
  var c = arguments.length, r = c < 3 ? target : desc3 === null ? desc3 = Object.getOwnPropertyDescriptor(target, key) : desc3, d2;
  if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc3);
  else for (var i = decorators.length - 1; i >= 0; i--) if (d2 = decorators[i]) r = (c < 3 ? d2(r) : c > 3 ? d2(target, key, r) : d2(target, key)) || r;
  return c > 3 && r && Object.defineProperty(target, key, r), r;
  ...
  templateLeftIcon() {
    if (this.icon) {
      return html`<wui-image
        icon=${this.icon}
        iconColor=${ifDefined2(this.iconColor)}
        ?boxed=${this.boxed}
    ...
    return html`<wui-image
      ...
      size=${ifDefined2(this.imageSize)}
      src=${this.imageSrc}
      boxColor=${this.boxColor}
    ></wui-image>`;
  }
...
var __decorate13 = function(decorators, target, key, desc3) {
  var c = arguments.length, r = c < 3 ? target : desc3 === null ? desc3 = Object.getOwnPropertyDescriptor(target, key) : desc3, d2;
  if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc3);
  else for (var i = decorators.length - 1; i >= 0; i--) if (d2 = decorators[i]) r = (c < 3 ? d2(r) : c > 3 ? d2(target, key, r) : d2(target, key)) || r;
  return c > 3 && r && Object.defineProperty(target, key, r), r;
...
var __decorate14 = function(decorators, target, key, desc3) {
  var c = arguments.length, r = c < 3 ? target : desc3 === null ? desc3 = Object.getOwnPropertyDescriptor(target, key) : desc3, d2;
  if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc3);
  else for (var i = decorators.length - 1; i >= 0; i--) if (d2 = decorators[i]) r = (c < 3 ? d2(r) : c > 3 ? d2(target, key, r) : d2(target, key)) || r;
  return c > 3 && r && Object.defineProperty(target, key, r), r;
...
var __decorate15 = function(decorators, target, key, desc3) {
  var c = arguments.length, r = c < 3 ? target : desc3 === null ? desc3 = Object.getOwnPropertyDescriptor(target, key) : desc3, d2;
  if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc3);
  else for (var i = decorators.length - 1; i >= 0; i--) if (d2 = decorators[i]) r = (c < 3 ? d2(r) : c > 3 ? d2(target, key, r) : d2(target, key)) || r;
  return c > 3 && r && Object.defineProperty(target, key, r), r;
...
lit-html/development/directives/class-map.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-T2TYKEMS.js.map
