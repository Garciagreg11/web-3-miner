...
import "./chunk-J7X5ZYSM.js";
import "./chunk-D3TMW26F.js";
import {
  ApiController,
  AppKitError,
  AssetController,
...
var W3mAllWalletsWidget = class W3mAllWalletsWidget2 extends LitElement2 {
  ...
  onAllWallets() {
    ...
    RouterController.push("AllWallets", { redirectView: (_a2 = RouterController.state.data) == null ? void 0 : _a2.redirectView });
  }
};
__decorate([
  property()
...
var W3mConnectorList = class W3mConnectorList2 extends LitElement2 {
  constructor() {
    ...
    this.unsubscribe.push(ConnectionController.subscribeKey("connections", (val) => this.connections = val), AssetController.subscribeKey("connectorImages", (val) => this.connectorImages = val), ApiController.subscribeKey("explorerFilteredWallets", (val) => {
      ...
      var _a2;
      if (!((_a2 = this.explorerWallets) == null ? void 0 : _a2.length)) {
  ...
  getConnectorNamespaces(item) {
    ...
    if (item.subtype === "multiChain") {
      return ((_a2 = item.connector.connectors) == null ? void 0 : _a2.map((c) => c.chain)) || [];
    }
  ...
  renderConnector(item, index) {
    ...
    return html2`
      <w3m-list-wallet
        ...
        tabIdx=${ifDefined(this.tabIdx)}
        ?disabled=${disabled}
        rdnsId=${ifDefined(((_a2 = connector.explorerWallet) == null ? void 0 : _a2.rdns) || void 0)}
        walletRank=${ifDefined((_b2 = connector.explorerWallet) == null ? void 0 : _b2.order)}
  ...
  constructor() {
    ...
    EventsController.sendEvent({
      ...
      properties: {
        ...
        platform: "browser",
        displayIndex: (_a2 = this.wallet) == null ? void 0 : _a2.display_index,
...
var W3mConnectingWcQrcode = class W3mConnectingWcQrcode2 extends W3mConnectingWidget {
  ...
  firstUpdated() {
    ...
    if (!this.basic) {
      EventsController.sendEvent({
        ...
        event: "SELECT_WALLET",
        properties: {
          name: ((_a2 = this.wallet) == null ? void 0 : _a2.name) ?? "WalletConnect",
          platform: "qrcode",
  ...
  disconnectedCallback() {
    var _a2;
    super.disconnectedCallback();
    (_a2 = this.unsubscribe) == null ? void 0 : _a2.forEach((unsub) => unsub());
  }
  render() {
    this.onRenderProxy();
    return html2`
  ...
  constructor() {
    ...
    EventsController.sendEvent({
      ...
      properties: {
        ...
        platform: "web",
        displayIndex: (_a2 = this.wallet) == null ? void 0 : _a2.display_index,
        walletRank: (_b2 = this.wallet) == null ? void 0 : _b2.order,
        view: RouterController.state.view
      }
    });
  }
...
var W3mConnectingWcView = class W3mConnectingWcView2 extends LitElement2 {
  ...
  reownBrandingTemplate() {
    var _a2;
    if (!((_a2 = this.remoteFeatures) == null ? void 0 : _a2.reownBranding) || !this.displayBranding) {
      return null;
    }
  ...
  platformTemplate() {
    switch (this.platform) {
      ...
      case "mobile":
        ...
        `;
      case "qrcode":
        return html2`<w3m-connecting-wc-qrcode ?basic=${this.basic}></w3m-connecting-wc-qrcode>`;
      default:
...
var W3mConnectingWcBasicView = class W3mConnectingWcBasicView2 extends LitElement2 {
  ...
  render() {
    if (this.isMobile) {
      ...
      return html2`<wui-flex flexDirection="column" gap="2" .margin=${["1", "3", "3", "3"]}>
        ${showConnectors ? html2`<w3m-connector-list></w3m-connector-list>` : null}
        <w3m-all-wallets-widget></w3m-all-wallets-widget>
      </wui-flex>`;
    }
    return html2`<wui-flex flexDirection="column" .padding=${["0", "0", "4", "0"]}>
  ...
  reownBrandingTemplate() {
    var _a2;
    if (!((_a2 = this.remoteFeatures) == null ? void 0 : _a2.reownBranding)) {
      return null;
    }
    return html2` <wui-flex flexDirection="column" .padding=${["1", "0", "1", "0"]}>
...
var WuiToggle = class WuiToggle2 extends LitElement {
  ...
  dispatchChangeEvent() {
    ...
    this.dispatchEvent(new CustomEvent("switchChange", {
      detail: (_a2 = this.inputElementRef.value) == null ? void 0 : _a2.checked,
      bubbles: true,
      composed: true
    }));
  }
  ...
  templateSubmitButton() {
    ...
    if (this.onSubmit) {
      return html`<button
        ...
        @click=${(_a2 = this.onSubmit) == null ? void 0 : _a2.bind(this)}
...
var W3mAllWalletsListItem = class W3mAllWalletsListItem2 extends LitElement2 {
  ...
  render() {
    var _a2, _b2;
    const certified = ((_a2 = this.wallet) == null ? void 0 : _a2.badge_type) === "certified";
    return html2`
      <button>
        ${this.imageTemplate()}
  ...
  imageTemplate() {
    ...
    return html2`
      <wui-wallet-image
        ...
        name=${ifDefined((_a2 = this.wallet) == null ? void 0 : _a2.name)}
        .installed=${((_b2 = this.wallet) == null ? void 0 : _b2.installed) ?? false}
        badgeSize="sm"
      >
      </wui-wallet-image>
    `;
  ...
  shimmerTemplate() {
    return html2`<wui-shimmer width="56px" height="56px"></wui-shimmer>`;
  }
  async fetchImageSrc() {
    if (!this.wallet) {
      return;
...
var W3mAllWalletsList = class W3mAllWalletsList2 extends LitElement2 {
  ...
  walletsTemplate() {
    return WalletUtil.getWalletConnectWallets(this.wallets).map((wallet, index) => html2`
        <w3m-all-wallets-list-item
...
var W3mAllWalletsSearch = class W3mAllWalletsSearch2 extends LitElement2 {
  ...
  render() {
    ...
    this.onSearch();
    return this.loading ? html2`<wui-loading-spinner color="accent-primary"></wui-loading-spinner>` : this.walletsTemplate();
  }
  async onSearch() {
  ...
  walletsTemplate() {
    ...
    return html2`
      <wui-grid
        ...
        justifyContent="space-between"
      >
        ${walletsByWcSupport.map((wallet, index) => html2`
            <w3m-all-wallets-list-item
              @click=${() => this.onConnectWallet(wallet)}
              .wallet=${wallet}
              data-testid="wallet-search-item-${wallet.id}"
  ...
  render() {
    ...
    return html2`
      ...
      ${isSearch || this.badge ? html2`<w3m-all-wallets-search
            query=${this.search}
            .badge=${this.badge}
          ></w3m-all-wallets-search>` : html2`<w3m-all-wallets-list .badge=${this.badge}></w3m-all-wallets-list>`}
    `;
  }
  onInputChange(event) {
...
lit-html/development/directives/ref.js:
   ...
   *)
*/
//# sourceMappingURL=basic-HNVV6B47.js.map
