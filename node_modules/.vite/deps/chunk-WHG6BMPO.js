    ...
    !function(t, e) {
      ...
      var _ = function() {
        ...
        return m3.parse = function(t2) {
          ...
          var $3, y2 = this, M3 = b2.p(d2), m4 = O2(r2), v3 = (m4.utcOffset() - this.utcOffset()) * e, g2 = this - m4, D2 = function() {
            return b2.m(y2, m4);
          };
          switch (M3) {
            case h:
        ...
        t.en.relativeTime = o, n.fromToBase = function(e2, n2, i2, d2, u) {
          for (var f, a, s, l = i2.$locale().relativeTime || o, h = r.thresholds || [{ l: "s", r: 44, d: "second" }, { l: "m", r: 89 }, { l: "mm", r: 44, d: "minute" }, { l: "h", r: 89 }, { l: "hh", r: 21, d: "hour" }, { l: "d", r: 35 }, { l: "dd", r: 25, d: "day" }, { l: "M", r: 45 }, { l: "MM", r: 10, d: "month" }, { l: "y", r: 17 }, { l: "yy", d: "year" }], m2 = h.length, c = 0; c < m2; c += 1) {
            ...
            if (s = f > 0, p <= y.r || !y.r) {
              p <= 1 && c > 0 && (y = h[c - 1]);
              var v2 = l[y.l];
              u && (p = u("" + p)), a = "string" == typeof v2 ? v2.replace("%d", p) : v2(p, n2, y.l, s);
              break;
            }
          }
          if (n2) return a;
...
P.cmp = function(y) {
  var isneg, x2 = this, xc = x2.c, yc = (y = new x2.constructor(y)).c, i = x2.s, j = y.s, k = x2.e, l = y.e;
...
P.div = function(y) {
  var x2 = this, Big2 = x2.constructor, a = x2.c, b2 = (y = new Big2(y)).c, k = x2.s == y.s ? 1 : -1, dp = Big2.DP;
  ...
  var bl, bt, n, cmp, ri, bz = b2.slice(), ai = bl = b2.length, al = a.length, r = a.slice(0, bl), rl = r.length, q = y, qc = q.c = [], qi = 0, p = dp + (q.e = x2.e - y.e) + 1;
  q.s = k;
  k = p < 0 ? 0 : p;
  bz.unshift(0);
  for (; rl++ < bl; ) r.push(0);
...
P.minus = P.sub = function(y) {
  var i, j, t, xlty, x2 = this, Big2 = x2.constructor, a = x2.s, b2 = (y = new Big2(y)).s;
  if (a != b2) {
    y.s = -b2;
    return x2.plus(y);
  }
  var xc = x2.c.slice(), xe = x2.e, yc = y.c, ye2 = y.e;
  if (!xc[0] || !yc[0]) {
    if (yc[0]) {
      y.s = -b2;
    } else if (xc[0]) {
  ...
  if ((b2 = (j = yc.length) - (i = xc.length)) > 0) for (; b2--; ) xc[i++] = 0;
  for (b2 = i; j > a; ) {
    if (xc[--j] < yc[j]) {
...
P.mod = function(y) {
  var ygtx, x2 = this, Big2 = x2.constructor, a = x2.s, b2 = (y = new Big2(y)).s;
  if (!y.c[0]) {
    throw Error(DIV_BY_ZERO);
  }
  x2.s = y.s = 1;
...
P.plus = P.add = function(y) {
  ...
  var xe = x2.e, xc = x2.c, ye2 = y.e, yc = y.c;
  if (!xc[0] || !yc[0]) {
    if (!yc[0]) {
      if (xc[0]) {
        y = new Big2(x2);
...
P.pow = function(n) {
  var x2 = this, one = new x2.constructor("1"), y = one, isneg = n < 0;
...
P.times = P.mul = function(y) {
  var c, x2 = this, Big2 = x2.constructor, xc = x2.c, yc = (y = new Big2(y)).c, a = xc.length, b2 = yc.length, i = x2.e, j = y.e;
  y.s = x2.s == y.s ? 1 : -1;
  if (!xc[0] || !yc[0]) {
    y.c = [y.e = 0];
    return y;
  ...
  for (c = new Array(j = a + b2); j--; ) c[j] = 0;
  for (i = b2; i--; ) {
    b2 = 0;
    for (j = a + i; j > i; ) {
...
// node_modules/@reown/appkit-controllers/node_modules/proxy-compare/dist/index.js
...
var canProxyDefault = (x2) => isObject(x2) && !refSet.has(x2) && (Array.isArray(x2) || !(Symbol.iterator in x2)) && !(x2 instanceof WeakMap) && !(x2 instanceof WeakSet) && !(x2 instanceof Error) && !(x2 instanceof Number) && !(x2 instanceof Date) && !(x2 instanceof String) && !(x2 instanceof RegExp) && !(x2 instanceof ArrayBuffer) && !(x2 instanceof Promise);
...
// node_modules/@reown/appkit-wallet/node_modules/@walletconnect/logger/dist/index.es.js
var b = { exports: {} };
function se(e) {
  try {
...
function v(e) {
  ...
  n.log || (n.log = z2), ue(n, u, r), R({}, n), Object.defineProperty(n, "levelVal", { get: l }), Object.defineProperty(n, "level", { get: L, set: a });
  const o = { transmit: t, serialize: i, asObject: e.browser.asObject, asObjectBindingsOnly: e.browser.asObjectBindingsOnly, formatters: e.browser.formatters, levels: u, timestamp: ye(e), messageKey: e.messageKey || "msg", onChild: e.onChild || z2 };
  ...
  }, n.setMaxListeners = n.getMaxListeners = n.emit = n.addListener = n.on = n.prependListener = n.once = n.prependOnceListener = n.removeListener = n.removeAllListeners = n.listeners = n.listenerCount = n.eventNames = n.write = n.flush = z2, n.serializers = s, n._serialize = i, n._stdErrSerialize = f, n.child = function(...g) {
...
function O(e, t, r, s) {
  if (Object.defineProperty(e, s, { value: m(e.level, r) > m(s, r) ? z2 : r[A][s], writable: true, enumerable: true, configurable: true }), e[s] === z2) {
  ...
  return /* @__PURE__ */ function(i) {
    return function() {
      ...
      if (t.serialize && (V(u, this._serialize, this.serializers, this._stdErrSerialize), o = true), t.asObject || t.formatters ? i.call(c, ...ve(this, s, u, h, t)) : i.apply(c, u), t.transmit) {
        ...
        if (a < L) return;
        me(this, { ts: h, methodLevel: s, methodValue: a, transmitLevel: l, transmitValue: r.levels.values[t.transmit.level || e._level], send: t.transmit.send, val: m(e._level, r) }, u, o);
      }
    };
  }(e[A][s]);
}
...
buffer/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-WHG6BMPO.js.map
